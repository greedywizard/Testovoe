...
class CreateToken(Scenario):
    ...
    def _exec(self):
        ...
        iframe = Actions.GetElement(self, By.XPATH, "//oz-wizard/iframe").Element
        ...
        result.code = Actions.GetElement(self, By.XPATH, "/html/body/div/div[2]/div[2]/pre/code").Element.text
